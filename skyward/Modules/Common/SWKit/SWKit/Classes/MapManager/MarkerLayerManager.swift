...
public struct MarkerStyle {
    ...
    static let selectedStyle = MarkerStyle(color: "white", size: [32, 40], order: 1000)
    static let hiddenStyle = MarkerStyle(color: "transparent", size: [0, 0], interactive: true, order: 0)
