...
class TabBarController: UITabBarController {
    ...
    private lazy var homeVC: HomeViewController = {
        ...
        vc.tabBarItem = UITabBarItem(title: "首页", image: nil, selectedImage: nil)
        vc.tabBarItem.tag = 1000
        return vc
    }()
    
    private lazy var mapVC: BaseViewController = {
        let vc = BaseViewController()
        vc.view.backgroundColor = .blue
        vc.tabBarItem = UITabBarItem(title: "地图", image: nil, selectedImage: nil)
    ...
    private lazy var messageVC: MessageViewController = {
        ...
        vc.tabBarItem = UITabBarItem(title: "消息", image: nil, selectedImage: nil)
        vc.tabBarItem.tag = 1002
        return vc
    }()
    
    private lazy var mineVC: BaseViewController = {
        let vc = BaseViewController()
        vc.view.backgroundColor = .orange
        vc.tabBarItem = UITabBarItem(title: "我的", image: nil, selectedImage: nil)
